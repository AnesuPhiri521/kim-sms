...
PERMISSIONS: dict[str, str] = {
    ...
    "fees:create_discount": "Create a discount/scholarship",
    "fees:approve_discount": "Approve a discount above threshold",
...
ROLE_DEFINITIONS: dict[str, str] = {
    ...
    "accountant": "Fee structures, payments, receipts, discounts, financial reports",
